...
def fix_word(pos_sent, ner_sent, dpt_sent, reverse):
    prefix_words = []
    infix_words = ['省会', '并入', '主峰', '位于', '位', '地处']
    suffix_words = []
    fea_vec = []
...
def prefix_words(pos_sent, ner_sent, dpt_sent, reverse):
    pass
